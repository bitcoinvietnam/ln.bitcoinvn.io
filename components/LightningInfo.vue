<template>
    <div class="py-4 md:py-10">
        <div class="bg-white rounded-sm">
            <div v-for="info in infoList" class="even:bg-gradient-to-br from-gray-100 via-gray-200 to-gray-100" :key="info.title">
                <div class="flex-col px-2 py-2 InfoBox md:px-5 md:flex-row">
                    <div class="py-2 InfoTitle md:py-0 md:min-w-max md:float-left md:w-2/3 md:px-5">
                        {{ info.title }}
                    </div>
